	...
	*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
	...
	cap program drop	 correcting_sample				
		...
		syntax, year1(integer) year2(integer) model(string)
			...
			However, when we test some models (restricting samples or adding controls), we may have to correct the sample one more time. 
			For ex, restricting the sample to schools in which there are no teachers working at the same time both in a state and in a locally-managed school
	...
	*=============================>>
			...
			**	
			use `file_reg', clear	
				...
				*Controls including socioeconomic variables for students + teachers' and principals' controls (we lose a significant amount of observations)
				...
				c.classrooms_het_performance##c.classrooms_het_performance c.tenure5##c.tenure5 ///
				c.prin5##c.prin5 c.student_effort_teacherpers5##c.student_effort_teacherpers5  i.absenteeism_teachers  c.mot5##c.mot5 
				...
				**
				sort 	codschool year
					...
					*/
					{
						...
						**
						if `sub' != 6 & `sub' != 7 & `sub' != 8 & `sub' != 4 & `sub' != 5 {								//for performance data, our placebo compares 2005 with 2007. 
							...
							**
							estimates store 		model`model'`sub'`grade', title("Placebo-DiD")
					...
					*/	
					{
						**
						reg 	`subject' 	    T2009	  								 		  i.T i.codmunic i.year  																		if (year == 2007 | year == 2009)      						 [aw = `weight'], cluster(codmunic)
							
						**
						correcting_sample, year1(2007) year2(2009) model(dif)
						reg 	`subject' 	    T2009	  								 		  i.T i.codmunic i.year 																		if (year == 2007 | year == 2009)   & corrected_sample == 1   [aw = `weight'], cluster(codmunic)

						**
						estimates store 	 	model0`sub'`grade', title("DiD-`model'`sub'") 
						mat_res, 	model(0) sub(`sub') var1(T2009) var2(novar) var3(novar)  dep_var(`subject') grade(`grade')
							
						**
						estadd local esp0	   = "Yes": model0`sub'`grade'  // municipal fixed effects
						estadd local esp1      = "No":  model0`sub'`grade'  // controls
						estadd local esp2	   = "No":  model0`sub'`grade'  // % teachers in both networks
						estadd local esp3	   = "No":  model0`sub'`grade'  // % teachers management program
						estadd local esp4	   = "No":  model0`sub'`grade'  // school fe
					...
					*/	
					{
						...
						**
						estimates store 	 	model`model'`sub'`grade', title("DiD-`model'`sub'") 
					...
					*/
					{
						**
						reg 	`subject' 	    T2009	  								 		  i.T i.codmunic i.year $controls_add2_2007																	if (year == 2007 | year == 2009)  							 [aw = `weight'], cluster(codmunic)
						
						**
						correcting_sample, year1(2007) year2(2009) model(dif)
						reg 	`subject' 	    T2009	  								 		  i.T i.codmunic i.year $controls_add2_2007																	if (year == 2007 | year == 2009)  & corrected_sample == 1    [aw = `weight'], cluster(codmunic)
					...
					**
					*TESTE - CAIO sem efeito fixo de mun
					*........................................>>> 
					**
					**
					if `sub' == 2 | `sub' == 3 { 
						**
						reg 	`subject' 	    T2009	  								 		  i.T  i.year $controls_add2_2007																	if (year == 2007 | year == 2009)  							 [aw = `weight'], cluster(codmunic)
						
						**
						correcting_sample, year1(2007) year2(2009) model(dif)
						reg 	`subject' 	    T2009	  								 		  i.T  i.year $controls_add2_2007																	if (year == 2007 | year == 2009)  & corrected_sample == 1    [aw = `weight'], cluster(codmunic)
						
						**	
						if `sub' == 2 estimates store 	 	model100`sub'`grade', title("TESTE -MATH") 
						if `sub' == 3 estimates store 	 	model100`sub'`grade', title("TESTE - PORT") 
					*........................................>>> 
					}
					...
					*/
					{
						...
						**
						reg 	`subject' 	    T2009	  										   i.T i.codmunic i.year $controls_add2_2007	 share_teacher_both_networks 									if (year == 2007 | year == 2009)     						 [aw = `weight'], cluster(codmunic)
						
						**
						correcting_sample, year1(2007) year2(2009) model(dif)
						reg 	`subject' 	    T2009	  										   i.T i.codmunic i.year $controls_add2_2007	 share_teacher_both_networks 									if (year == 2007 | year == 2009)  & corrected_sample == 1    [aw = `weight'], cluster(codmunic)
					...
					*/
					{
						**
						reg 	`subject' 	    T2009	  										   i.T i.codmunic i.year $controls_add2_2007	 share_teacher_management_program 							 	if (year == 2007 | year == 2009) 						  [aw = `weight'], cluster(codmunic)
					
						**
						correcting_sample, year1(2007) year2(2009) model(dif)
						reg 	`subject' 	    T2009	  										   i.T i.codmunic i.year $controls_add2_2007	 share_teacher_management_program 							 	if (year == 2007 | year == 2009) & corrected_sample == 1  [aw = `weight'], cluster(codmunic)
					...
					*/
					{
						**
						reg 	`subject' 	    T2009	  										   i.T i.codmunic i.year $controls_add2_2007	 share_teacher_both_networks share_teacher_management_program 	if (year == 2007 | year == 2009) 						  [aw = `weight'], cluster(codmunic)
						
						**
						correcting_sample, year1(2007) year2(2009) model(dif)
						reg 	`subject' 	    T2009	  										   i.T i.codmunic i.year $controls_add2_2007	 share_teacher_both_networks share_teacher_management_program 	if (year == 2007 | year == 2009)  & corrected_sample == 1 [aw = `weight'], cluster(codmunic)
						...
						if `grade' == 5 & (`sub' == 2 | `sub' == 3) {
							...
							**
							foreach variable in $interactions { //
								...
								**		
								reg 	`subject' T2009 T2009_`variable'`grade' `variable'`grade'   i.T i.codmunic i.year $controls_add2_2007 share_teacher_both_networks share_teacher_management_program  	if (year == 2007 | year == 2009) 							[aw = `weight'], cluster(codmunic)
								
								**
								correcting_sample, year1(2007) year2(2009) model(dif)
								reg 	`subject' T2009 T2009_`variable'`grade' `variable'`grade'   i.T i.codmunic i.year $controls_add2_2007 share_teacher_both_networks share_teacher_management_program  	if (year == 2007 | year == 2009) & corrected_sample == 1	[aw = `weight'], cluster(codmunic)
								...
								**
								reg 	`subject' T2009 T2009_adeq`subject' adeq`subject' 	 	    i.T i.codmunic i.year $controls_add2_2007 share_teacher_both_networks share_teacher_management_program 	if (year == 2007 | year == 2009)  							[aw = `weight'], cluster(codmunic)
								
								**
								correcting_sample, year1(2007) year2(2009) model(dif)
								reg 	`subject' T2009 T2009_adeq`subject' adeq`subject' 	 	    i.T i.codmunic i.year $controls_add2_2007 share_teacher_both_networks share_teacher_management_program 	if (year == 2007 | year == 2009) & corrected_sample == 1  	[aw = `weight'], cluster(codmunic)
								...
								**
								reg 	`subject' T2009 T2009_reddrop reddrop	 	   	   i.T i.codmunic i.year $controls_add2_2007 share_teacher_both_networks share_teacher_management_program	 if (year == 2007 | year == 2009)  							[aw = `weight'], cluster(codmunic)
								
								**
								correcting_sample, year1(2007) year2(2009) model(dif)
								reg 	`subject' T2009 T2009_reddrop reddrop  	 	   	   i.T i.codmunic i.year $controls_add2_2007 share_teacher_both_networks share_teacher_management_program 	 if (year == 2007 | year == 2009) & corrected_sample == 1  	[aw = `weight'], cluster(codmunic)
					...
					*-------------------------------------------------------------------------------------------------------------------------------------------------------------------*
					/* 
					Model 15: DiD, impact by deciles
					*/
					...
					use `file_reg' if network == 3, clear					
						...
						if `grade' == 5 & (`sub' == 2 | `sub' == 3) {
							foreach quantile in 10 20 30 40 50 60 70 80 90 { 
								**
								cic 	continuous `subject' T post_treat $controls_add2_2007 share_teacher_both_networks share_teacher_management_program  i.codmunic 									if (year == 2007 | year == 2009)  [aw = `weight'], did at(`quantile') vce(bootstrap, reps(1000))
			...
			*/
					...
					*/
					...
					clonevar T2009 = beta7
						...
						**
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007 																if (year == 2007 | year == 2009) 							[aw = `weight'] , cluster(codschool)
						
						**
						correcting_sample, year1(2007) year2(2009) model(triple)
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007 																if (year == 2007 | year == 2009) & corrected_sample == 1 	[aw = `weight'] , cluster(codschool)
						
						**
						estimates store 		model`model'`sub'`grade', title("Triple-DiD-`model'`sub'")   
						mat_res, 	model(`model') sub(`sub') var1(T2009) var2(novar) var3(novar) dep_var(`subject') grade(`grade')	
					...
					*/
					{
						**
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_both_networks  	 							if (year == 2007 | year == 2009) 							[aw = `weight'] , cluster(codschool)
						
						**
						correcting_sample, year1(2007) year2(2009) model(triple)
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_both_networks 								if (year == 2007 | year == 2009) & corrected_sample == 1  	[aw = `weight'],  cluster(codschool)
					...
					*/
					{
						**
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program 							if (year == 2007 | year == 2009) 							[aw = `weight'] , cluster(codschool)
						
						**
						correcting_sample, year1(2007) year2(2009) model(triple)
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program    						if (year == 2007 | year == 2009) & corrected_sample == 1 	[aw = `weight'], cluster(codschool)
					...
					*/
					{
						**
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks if (year == 2007 | year == 2009) 								[aw = `weight'], cluster(codschool)
						
						**
						correcting_sample, year1(2007) year2(2009) model(triple)
						reg 	`subject' T2009 										 beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks if (year == 2007 | year == 2009) & corrected_sample == 1  	[aw = `weight'],cluster(codschool)
					...
					*/
					{
						**
						xtreg 	`subject' T2009 									    beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks	if (year == 2007 | year == 2009),  							fe 	cluster(codschool)
						
						**
						correcting_sample, year1(2007) year2(2009) model(triple)
						xtreg 	`subject' T2009 									    beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks	if (year == 2007 | year == 2009) & corrected_sample == 1 ,  fe 	cluster(codschool)
					...
					**
					**
					*Robustness 1: 2009 versus 2007, no controls
					*-------------------------------------------------------------------------------------------------------------------------------------------------------------------*
					/*
					Model 50 
					*/
					{
						**
						xtreg 	`subject' T2009 									    beta1-beta6 i.codmunic 	if (year == 2007 | year == 2009),  							fe 	cluster(codschool)
						
						**
						correcting_sample, year1(2007) year2(2009) model(triple)
						xtreg 	`subject' T2009 									    beta1-beta6 i.codmunic  if (year == 2007 | year == 2009) & corrected_sample == 1 ,  fe 	cluster(codschool)
						
							
						**
						estimates store 		model50`sub'`grade', title("Triple-DiD-`model'`sub'")  
						mat_res, 	model(50) sub(`sub') var1(T2009) var2(novar) var3(novar) dep_var(`subject') grade(`grade')	
							
						**
						estadd local esp0	   = "Yes": model50`sub'`grade'  // municipal fixed effects
						estadd local esp1      = "No": model50`sub'`grade'  // controls
						estadd local esp2	   = "No": model50`sub'`grade'  // % teachers in both networks
						estadd local esp3	   = "No": model50`sub'`grade'  // % teachers management program
						estadd local esp4	   = "Yes": model50`sub'`grade'  // school fe
					...
					**
					if `grade' == 5 & (`sub' == 2 | `sub' == 3) {
						...
						**
						foreach variable in $interactions { //
							**
							xtreg 	`subject' T2009 T2009_`variable'`grade' `variable'`grade'  beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009)						, fe	cluster(codschool)
							
							**
							correcting_sample, year1(2007) year2(2009) model(triple)
							xtreg 	`subject' T2009 T2009_`variable'`grade' `variable'`grade'  beta1-beta6 i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks if (year == 2007 | year == 2009) & corrected_sample == 1 , fe	cluster(codschool)
							...
							**
							xtreg 	`subject' T2009 T2009_adeq`subject' adeq`subject' 	 	   beta1-beta6 i.codmunic $controls_add2_2007 share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009)						 	, fe		cluster(codschool)
							
							
							**
							correcting_sample, year1(2007) year2(2009) model(triple)
							xtreg 	`subject' T2009 T2009_adeq`subject' adeq`subject' 	 	   beta1-beta6 i.codmunic $controls_add2_2007 share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009) & corrected_sample == 1 , fe		cluster(codschool)
							...
							**
							xtreg 	`subject' T2009 T2009_hw`subject' hw`subject' 	 	   beta1-beta6 i.codmunic $controls_add2_2007 share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009) 							, fe		cluster(codschool)
							
							**
							correcting_sample, year1(2007) year2(2009) model(triple)
							xtreg 	`subject' T2009 T2009_hw`subject' hw`subject' 	 	   beta1-beta6 i.codmunic $controls_add2_2007 share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009) & corrected_sample == 1 	, fe		cluster(codschool)
							...
							**
							xtreg 	`subject' T2009 T2009_reddrop reddrop 	 	   			beta1-beta6 i.codmunic $controls_add2_2007 share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009) 							, fe		cluster(codschool)
							
							**
							correcting_sample, year1(2007) year2(2009) model(triple)
							xtreg 	`subject' T2009 T2009_reddrop reddrop 	 	   			beta1-beta6 i.codmunic $controls_add2_2007 share_teacher_management_program share_teacher_both_networks  if (year == 2007 | year == 2009) & corrected_sample == 1 	, fe		cluster(codschool)
					...
					*/
					{
						...
						if `grade' == 5 & (`sub' == 2 | `sub' == 3) {
							foreach quantile in 10 20 30 40 50 60 70 80 90 { 
								cic 	continuous `subject' beta4 beta3 beta1 beta2 beta5 beta6 		i.codmunic $controls_add2_2007  share_teacher_management_program share_teacher_both_networks  [aw = `weight'], did at(`quantile') vce(bootstrap, reps(1000))
								matrix 	reg_results = r(table)
									matrix results = results \ (`model', `sub', reg_results[1, colsof(reg_results)-2], reg_results[5,colsof(reg_results)-2], reg_results[6,colsof(reg_results)-2], `quantile', `grade')	 	
								}
						}
					...
					**
					if `sub' == 6 | `sub' == 7 | `sub' == 8 {
						...
						clonevar  T2008 = beta7P2						
							...
							**
							reg 	`subject' T2008											 beta1P2-beta6P2 i.codmunic $controls2008  share_teacher_management_program share_teacher_both_networks	 if (year == 2007 | year == 2008)  [aw = `weight']  , cluster(codschool)
							
							**
							correcting_sample, year1(2007) year2(2008) model(triple)
							reg 	`subject' T2008											 beta1P2-beta6P2 i.codmunic $controls2008  share_teacher_management_program share_teacher_both_networks	  if (year == 2007 | year == 2008) & corrected_sample == 1  [aw = `weight'] , cluster(codschool)
							
							estimates store 		model`model'`sub'`grade', title("Triple-DiD-`mode'`sub'") 
							mat_res, 	model(`model') sub(`sub') var1(T2008) var2(novar) var3(novar) dep_var(`subject') grade(`grade')	
		...
		*Table 4 -> Interactions - principals, DiD & Triple Dif
		{
			...
			using "$tables/Table4.xls",keep(T2009 T2009_prin5 T2009_reddrop) 		label cells(b(star  fmt(2)) se(par(`"="("' `")""') fmt(2)) pvalueboots(  fmt(2))) 				starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " )) replace
		
			estout model2425 model2725 model3225  ///
				   model2435 model2735 model3235 ///
			using "$tables/Table4.xls",keep(T2009 T2009_prin5 T2009_reddrop) 		label cells(b(star  fmt(2)) se(par(`"="("' `")""') fmt(2)) pvalueboots(  fmt(2))) 				starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " )) append 
		}	
		...
		*Table 5 -> Interactions - Teachers, DiD & Triple Dif
		{
			...
			using "$tables/Table5.xls",keep(T2009 T2009_spt5 T2009_absen5 T2009_hwport5 T2009_hwmath5) 		label cells(b(star fmt(2)) se(par(`"="("' `")""') fmt(2)) pvalueboots(  fmt(2))) 					starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " )) replace
			
			estout  model2425 model2625 model2825  model3125 ///
					model2435 model2635 model2835  model3135 ///
			using "$tables/Table5.xls",keep(T2009 T2009_spt5 T2009_absen5 T2009_hwport5 T2009_hwmath5) 		label cells(b(star  fmt(2)) se(par(`"="("' `")""') fmt(2)) pvalueboots(  fmt(2))) 											starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " )) append 
		 }
		...
		*Table A.12 -> Placebo
		{		
			...
			using "$tables/TableA12.xls",keep(T2007 T2009*)  label cells(b(star pvalue(pvalueboots) fmt(2)) se(par(`"="("' `")""') fmt(2)) pvalueboots(  fmt(2))) 				starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space space esp0 esp1 esp2 esp3 esp4, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " "Specifications" "Municipal FE" "Controls" "Both networks" "% management program" "School FE" )) replace
		}
		
		
		*---------------------------->>
		*Table A.13 -> Approval, Repetition and Dropout
		{
			estout model3465 model665 model2065 model2465 ///
				   model3475 model675 model2075 model2475 ///
				   model3485 model685 model2085 model2485 ///
		    using "$tables/TableA13.xls",keep(T2008  T2009*) label cells(b(star   fmt(3)) se(par(`"="("' `")""') fmt(2)) p) 																		starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space space mediaT sdT att_sdT space  space esp0 esp1 esp2 esp3 esp4, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " "Treatment Group, 2007" "Mean" "Standard Deviation" "Estimate of ATT (in sd)" " " "Specifications" "Municipal FE" "Controls" "Both networks" "% management program" "School FE" )) replace
		}
	...
	*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*
			...
			**
			foreach model in 33 {
				...
				foreach sub in 2 3  {		
						...
						if `model' == 33 & `sub' == 2 local t = "a"
						if `model' == 33 & `sub' == 3 local t = "b"
						*if `model' == 15 & `sub' == 2 local t = "b"
						*if `model' == 15 & `sub' == 3 local t = "d"
	...
	/*
		...
		*---------------------------->>
		*Table A.15 tese ->  rodar sem dropar escolas participantes do managerial practices intervention
		estout model2025 model2125 model2225 model2325 model2425 model2035 model2135 model2235 model2335 model2435 ///
			using "$tables/TableA14.xls", keep(T2009*) 		label cells(b(star fmt(2)) se(par(`"="("' `")""') fmt(2)) p(fmt(4)) ci(par fmt(1))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space space mediaT sdT att_sdT space  space esp0 esp1 esp2 esp3 esp4, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " "Treatment Group, 2007" "Mean" "Standard Deviation" "Estimate of ATT (in sd)" " " "Specifications" "Municipal FE" "Controls" "Both networks" "% management program" "School FE" )) replace
		...
		*---------------------------->>
		*Table A.16 tese- > with and without controls
		estout model025 model325 model425 model625  model5025 model2425 ///
		       model035 model335 model435 model635  model5035 model2435 ///
			using "$tables/TableA15.xls", keep(T2009*) 		label cells(b(star pvalue(pvalueboots) fmt(2)) se(par(`"="("' `")""') fmt(2)) pvalueboots(  fmt(4)) ci(par fmt(1))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2 space space mediaT sdT att_sdT space  space esp0 esp1 esp2 esp3 esp4, fmt(%9.0g %9.1f %9.2f) labels("N. schools" "R2" " " "Treatment Group, 2007" "Mean" "Standard Deviation" "Estimate of ATT (in sd)" " " "Specifications" "Municipal FE" "Controls" "Both networks" "% management program" "School FE" )) replace
